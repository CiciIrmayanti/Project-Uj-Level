	...
	<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<video width="80%" controls autoplay loop style="margin-left: 100px;margin-top:15px">
					<source src="<?php echo base_url().'assets/video/Animasi Anekdot _fasilitas kantin sekolah_.mp4';?>"
						type="video/mp4">
				</video>
			</div>
		</div>
